...
, function(e, t, n) {
    ...
    var s, v, m = -1 < navigator.userAgent.indexOf("MSIE ") || -1 < navigator.userAgent.indexOf("Trident/index.html") || -1 < navigator.userAgent.indexOf("Edge/index.html"), p = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), d = function() {
        ...
        return function(e, t, o) {
                ...
                if (o.videoImage)
                    ...
                    if ("youtube" === o.type) {
                        var e = ["maxresdefault", "sddefault", "hqdefault", "0"]
                          ...
                          , n = new Image;
                        n.onload = function() {
                            120 !== (this.naturalWidth || this.width) || i === e.length - 1 ? (o.videoImage = "https://img.youtube.com/vi/".concat(o.videoID, "https://www.pxdraft.com/").concat(e[i], ".jpg"),
                            t(o.videoImage)) : (i++,
                            this.src = "https://img.youtube.com/vi/".concat(o.videoID, "https://www.pxdraft.com/").concat(e[i], ".jpg"))
                        }
                        ,
                        n.src = "https://img.youtube.com/vi/".concat(o.videoID, "https://www.pxdraft.com/").concat(e[i], ".jpg")
                    }
                    if ("vimeo" === o.type) {
                        var a = new XMLHttpRequest;
                        a.open("GET.html", "https://vimeo.com/api/v2/video/".concat(o.videoID, ".json"), !0),
            ...
            value: function() {
                if (!l || !p) {
                    ...
                    e = "../../../player.vimeo.com/api/player.js"),
                    e) {
